...
public class Main {
    ...
    public static boolean changeBalance(Account account, Operation operation, Long sum) {
        switch (operation) {
            case DEPOSIT:
                return doDeposit(account, sum);
            default:
                return doWithdraw(account, sum);
        }
    }

    private static boolean doWithdraw(Account account, Long sum) {
    ...
    private static boolean doDeposit(Account account, Long sum) {
        account.setBalance(account.getBalance() + sum);
        return true;
    }
