...
class Address implements Comparable<Address> {
    ...
    public int compareTo(Address that) {
        if (this.house.compareTo(that.house) != 0) {
            return this.house.compareTo(that.house);
        } else if (this.street.compareTo(that.street) != 0) {
            return this.street.compareTo(that.street);
        } else {
